...
// 20 minutes of real time per in-game day: hunger drains fully in ~11 hours
// if the pet is left alone, so it wants attention three or four times a day.
export const TICK_MS = 20 * 60 * 1000;
